...
class RecoveredCases : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_recovered_cases, container, false)
        val sharedPreferences: SharedPreferences = requireContext().getSharedPreferences(prefFile,0)
        chart = view.findViewById(R.id.recoveredLineGraph)
            ...
            val jsonObjectRequest = JsonObjectRequest(
                ...
                Response.Listener { response ->
                    ...
                    for (i in dateStore)
                    {
                        ...
                        activeCasesList.add(delta.getString("recovered"))
                    ...
                    var lineDataSet = LineDataSet(entries,"Recovered Cases")
                    ...
                    lineDataSet.setColor(resources.getColor(R.color.spanishGreen))
                    lineDataSet.fillColor = resources.getColor(R.color.spanishGreen)
